                ...
                <tbody>
                    ...
                    <tr id="filas" class=" border-b  dark:border-gray-700" style="color: rgb(44, 62, 80)">
                            <th scope="row" class="px-6 py-4 font-medium text-gray-50 whitespace-nowrap dark:text-white">
                                <b style="color: rgb(44, 62, 80)">{{$confirmacion->id}}</b>
                            </th>
                            <td class="px-6 py-4 ">
                                <b style="color: rgb(44, 62, 80)">{{$confirmacion->name}}</b>
                            </td>
                            <td class="px-6 py-4">
                                <b style="color: rgb(44, 62, 80)">{{$confirmacion->cedula}}</b>
                            </td>
                            <td class="px-6 py-4">
