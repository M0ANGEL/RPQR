                ...
                @foreach ($reports as $report)
                    <tr id="filas" class=" border-b  dark:border-gray-700" style="color: rgb(44, 62, 80)">
                        ...
                        @if ($report->estado === 1)
                            <td>
                                <button
                                    style="color:rgb(243, 243, 243); background: red; padding: 5px; border-radius: 9px;"
                                    onclick="mostrarAlerta('{{ $report->rechazo }}')">
                        ...
                        @switch($report->estado_sebthi)
                            ...
                            @case(1)
                                <td style="color: rgb(44, 62, 80)">
                                    <p style="color:rgb(79, 121, 15)"><b>Realizado</b></p>
                                </td>
                            @break
