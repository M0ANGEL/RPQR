<x-app-layout>
    ...
    class="bg-white rounded-lg p-6" style="box-shadow: 0 4px 6px rgba(0, 0, 0, 1); "> {{-- /* Sombra del formulario */ --}}
        ...
        <div class="mb-4">
            ...
            <x-input 
            name="password_sebthi" type="password" class="w-full"  required />
        </div>
        ...
        <div class="mb-4">
            ...
            <label class="inline-flex items-center cursor-pointer">
                ...
                name="activo_sebthi" class="sr-only peer"
                @checked(old('activo_sebthi',$redvital->activo_sebthi == 1))>
