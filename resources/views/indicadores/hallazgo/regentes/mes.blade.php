...
<x-app-layout>    
  ...
  <div class="flex justify-end mb-4">
    ...
    href="{{route('graficaMes.index')}}">GRAFICAS MES</a>
  </div>
        ...
        <tbody>
             ...
             <tr id="filas" class=" border-b dark:bg-gray-800 dark:border-gray-700" style="color: rgb(44, 62, 80)">
                    ...
                    @if ($dato->porcentaje >5)
                      <td style="color: rgb(5, 35, 59)" class="px-6 py-4" style="background: rgb(255, 172, 172);">
                        <b>{{ $dato->porcentaje}} %</b>
                      </td>
                    @else
                        <td style="color: rgb(5, 35, 59)" class="px-6 py-4" style="background: rgb(16, 156, 14); color:white;" >
                            <b>{{ $dato->porcentaje}} %</b>
                        </td>
                    @endif
