...
<x-app-layout>
    ...
    <form action="{{ route('Planeacion.store') }}" method="POST" id="myForm" class="bg-white rounded-lg p-6"
        style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 1); "> {{-- /* Sombra del formulario */ --}}
        @csrf
        <div class="text-center">
            <h1><b>REGISTRO MENSUAL DE PROBLEMAS EN LA PLANEACION</b></h1>
            <p>Recuerda, tienes plazo de responder los 5 primeros dias de cada mes</p>
        </div>
        <div class="mb-4">
            <x-label>
                Total de productos que ingresaron
            </x-label>
    ...
    <div class="mt-4" style="float: right">
        ...
        <x-button class="mt-4 ml-4" style="background-color: rgb(1, 36, 78)">
            <a href="{{ route('Planeacion.index') }}">Vista datos mes</a>
        </x-button>
    </div>
