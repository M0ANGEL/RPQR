<x-app-layout>
    <div class="flex justify-end mb-4">
        <a style="background-color: rgb(8, 35, 99)"
            ...
            href="{{ route('Tikes.cerrados') }}">Volver al Menu</a>
    </div>
    ...
    <form action="" method="POST" class="bg-white rounded-lg p-6 shadow-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="mb-4">
                ...
                <textarea id="descripcion" cols="" rows="3"
                    class="border w-full focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" readonly>{{ $Tike->respuesta }}</textarea>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
                ...
                <x-input class="w-full" value="{{ $Tike->updated_at }}" readonly />
            </div>
            <div>
                <x-label>Encargado de realizar el proceso</x-label>
                <x-input class="w-full" value="{{ $Tike->user->name }}" readonly />
            </div>
        </div>
        <div class="flex justify-center items-center space-x-4 mt-4">
            <h4>Calificacion: </h4>
            @switch($Tike->calificacion)
                @case(1)
                    <div class="mr-4">
