<x-app-layout>
    ...
    <div class="flex justify-end mb-4">
        <a style="background-color: rgb(60, 94, 10)"
            ...
            href="{{ route('ReporteImpresora.create') }}">REPORTAR/IMPRESORA</a>
    </div>
                    ...
                    @foreach ($datos as $dato)
                        <tr id="filas" class=" border-b  dark:border-gray-700" style="color: rgb(44, 62, 80)">
                            <th scope="row"
                                ...
                                <b style="color: rgb(44, 62, 80)">{{ $dato->id }}</b>
                            </th>
                            <td class="px-6 py-4 ">
                                <b style="color: rgb(44, 62, 80)">{{ $dato->created_at }}</b>
                            </td>
                            <td class="px-6 py-4 ">
                                <b style="color: rgb(44, 62, 80)">{{ $dato->serial }}</b>
                            </td>
                            <td class="px-6 py-4">
                                <b style="color: rgb(44, 62, 80)">{{ $dato->problema }}</b>
                            </td>
                            <td class="px-6 py-4">
                                <b style="color: rgb(44, 62, 80)">{{ $dato->area }}</b>
                            </td>
                            <td class="px-6 py-4">
                                <b style="color: rgb(44, 62, 80)">{{ $dato->piso }}</b>
                            </td>
                            <td class="px-6 py-4">
                                @switch($dato->estado)
                                    @case(1)
