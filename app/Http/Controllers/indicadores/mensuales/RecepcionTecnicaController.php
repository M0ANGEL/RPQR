...
use App\Models\indicadores\RecepcionTecnica;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;

class RecepcionTecnicaController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $datos = RecepcionTecnica::where('bodega', $bodega)
            ...
            ->orderBy('month')
            ->paginate();
        return view('indicadores.mensuales.recepcion_tecnica.regentes.index', compact('datos'));
    }

    public function create()
    {
        $usuario = Auth::user();
        return view('indicadores.mensuales.recepcion_tecnica.regentes.create', compact('usuario'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('RecepcionTecnica.index');
    }
