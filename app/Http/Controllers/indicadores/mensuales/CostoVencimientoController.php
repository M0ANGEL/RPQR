...
use App\Models\CostoVencimiento as ModelsCostoVencimiento;
use App\Models\indicadores\CostoVencimiento;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Auth;
use Illuminate\Support\Facades\DB;

class CostoVencimientoController extends Controller
{
    public function index()
    {
        $bodega = Auth::user()->bodega;
        $datos = ModelsCostoVencimiento::where('bodega', $bodega)
            ...
            ->orderBy('month')
            ->paginate();
        return view('indicadores.mensuales.costo_vencimiento.regentes.index', compact('datos'));
    }

    public function create()
    {
        $usuario = Auth::user();
        return view('indicadores.mensuales.costo_vencimiento.regentes.create', compact('usuario'));
    }
